  ...
  return (
    <section className={styles.about}>
      ...
      <div className={styles.text}>
        <p>
          hi! i&apos;m dat. i am a student at mit studying cs. i&apos;m passionate about building
          technology that serves and considers people.
        </p>
        <p>
          currently, i am exploring ai safety and research. most recently, i worked at{' '}
          <InlineLink href="/experience">netic</InlineLink>, building out agent harnesses and
          evals for essential services businesses. before that, i founded{' '}
          <InlineLink href="/experience">horus health</InlineLink>, building ai for hospital
          revenue teams, and previously worked at{' '}
